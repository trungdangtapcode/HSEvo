...
import sys
sys.path.append('../../')
from baselines.eoh.gls_tsp_adapt.tsp_eval_helper import readTSPRandom, readTSPLib
from baselines.eoh.gls_tsp_adapt.tsp_eval_helper.gls_run import solve_instance
